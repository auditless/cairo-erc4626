...
from yagi.staking.interfaces.ISplitter import ISplitter
...
func constructor{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        asset : felt, name : felt, symbol : felt, splitter : felt):
    ERC4626.initializer(asset, name, symbol)
    splitter_.write(splitter)
    return ()
end
...
func totalAssets{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
    ...
    let (total_assets) = SafeUint256.add(vault_balance, splitter_balance)
    return (total_assets)
end
